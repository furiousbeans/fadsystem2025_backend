...
while ($pg_row = pg_fetch_assoc($pg_result)) {
    $showdetails = $pg_row['particulars'] .'<br>';
    // $showdetails = $pg_row['details'] .'<br>';
}



$pg_query = "SELECT division FROM orstbl2025 WHERE ors_random ='$orsidtest'";
...
$finalprint = $html1 . implode('<br>', $showpartics) .'<br>&nbsp;'. $html2 . $showdiv. $html3 . implode('<br>', $showmfopap) . $html4 . implode('<br>', $showamount) . $html5 . number_format($nets,2) . $html6 . $showtotalsum;
